          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            <div>
              ...
              <Paragraph style={{ fontSize: '16px', lineHeight: '1.8', textAlign: 'left' }}>
                ...
                ❌毒唯⭕同擔<br/><br/>
                目前主要以二代為主，本人是超級團粉，非常喜歡成員之間的互動，以及那種很強烈的團魂感。對二代的各CP都是喜歡與包容的態度，不雷任何一位成員。<br/>
                至於為什麼會上樓，是在16年被朋友推坑的。先是認識並深入了解TFBOYS，之後開始補他們的物料、演唱會和綜藝節目。後來得知 sdfj 也有推出了二代，便順帶關注了一下。真正開始認真看二代物料，是因為小馬的〈小星星〉，那首歌對我來說就像白月光般的存在。那段時間也很喜歡祺澤CP。<br/><br/>
