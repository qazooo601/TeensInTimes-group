          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            <div>
              ...
              <Paragraph style={{ fontSize: '16px', lineHeight: '1.8', textAlign: 'left' }}>
                ...
                三、四、五代沒特別追。<br/>
                不拒同擔，CP都磕。<br/><br/>
                目前主要以二代為主，本人是超級團粉，非常喜歡成員之間的互動，還有那滿滿的團魂感，不雷任何一位成員。<br/>
                至於為什麼會上樓，在16年時被朋友推坑。先是認識了解TFBOYS之後，開始補他們的物料、演唱會和綜藝節目。後來知道 sdfj 也有推出了二代，便順帶關注了一下。真正開始認真看二代物料，是因為小馬的〈小星星〉，那首歌對我來說就是白月光。那段時間很喜歡祺澤CP。<br/><br/>
